...
public class AdapterDemandeStage extends RecyclerView.Adapter<AdapterDemandeStage.myviewholder> {

    ArrayList<Demandemodel> datamodels;
    private final Context ct;

    public AdapterDemandeStage(ArrayList<Demandemodel> datamodels, Context ct) {
